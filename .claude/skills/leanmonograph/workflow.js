export const meta = {
  ...
  phases: [
    ...
    { title: 'Build',       detail: 'build.py + lint.py (adjudication des flags) + lint de contraste sombre → 1 HTML + auto-vérifs' },
  ],
};
